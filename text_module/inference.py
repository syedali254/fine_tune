...
WEIGHTS_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "best_model.pt")
MAX_LENGTH   = 128
TEMPERATURE  = 3  # for temperature scaling and we have tested that 3 is the best value for this model 
NUM_CLASSES  = 8
